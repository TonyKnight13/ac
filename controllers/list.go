...
func (ls *ListController) List() {
	pno, _ := ls.GetInt("pno")
	jsoninfoGet := ls.GetString("jsoninfo")
	...
	po.PageSize = 10
	po.TableName = "goodsinfo"

	totalitem, qs := GetPageInfo(&po, conditions string, titles []string, list []string)
}
